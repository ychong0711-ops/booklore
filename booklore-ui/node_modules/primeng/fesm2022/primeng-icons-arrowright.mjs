...
class ArrowRightIcon extends BaseIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: ArrowRightIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.0.5", type: ArrowRightIcon, isStandalone: true, selector: "[data-p-icon=\"arrow-right\"]", usesInheritance: true, ngImport: i0, template: `
        <svg:path
            fill-rule="evenodd"
            clip-rule="evenodd"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: ArrowRightIcon, decorators: [{
            type: Component,
            args: [{
