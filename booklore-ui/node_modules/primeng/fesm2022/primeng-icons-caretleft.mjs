...
class CaretLeftIcon extends BaseIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: CaretLeftIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.0.5", type: CaretLeftIcon, isStandalone: true, selector: "[data-p-icon=\"caret-left\"]", usesInheritance: true, ngImport: i0, template: `
        <svg:path
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: CaretLeftIcon, decorators: [{
            type: Component,
            args: [{
