...
class ArrowDownLeftIcon extends BaseIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: ArrowDownLeftIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.0.5", type: ArrowDownLeftIcon, isStandalone: true, selector: "[data-p-icon=\"arrow-down-left\"]", usesInheritance: true, ngImport: i0, template: `
        <svg:path
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: ArrowDownLeftIcon, decorators: [{
            type: Component,
            args: [{
