...
class BaseIconStyle extends BaseStyle {
    name = 'baseicon';
    css = css;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: BaseIconStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: BaseIconStyle, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: BaseIconStyle, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class BaseIcon extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: BaseIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "16.1.0", version: "21.0.5", type: BaseIcon, isStandalone: true, selector: "ng-component", inputs: { spin: ["spin", "spin", booleanAttribute] }, host: { attributes: { "width": "14", "height": "14", "viewBox": "0 0 14 14", "fill": "none", "xmlns": "http://www.w3.org/2000/svg" }, properties: { "class": "getClassNames()" } }, providers: [BaseIconStyle], usesInheritance: true, ngImport: i0, template: ` <ng-content></ng-content> `, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.5", ngImport: i0, type: BaseIcon, decorators: [{
            type: Component,
            args: [{
